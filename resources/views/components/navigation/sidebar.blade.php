<div class="hidden w-30 overflow-y-auto bg-indigo-700 dark:bg-gray-900 md:block border-r border-white/5">
    <div class="flex w-28 flex-col items-center py-6">
        ...
        <div class="mt-6 w-full flex-1 space-y-1 px-2">
            ...
            <a wire:navigate href="{{ route('alem.employees') }}"
               class="{{ request()->routeIs('alem.employees') || request()->routeIs('employees.profile') ? 'text-white bg-indigo-800 dark:text-white dark:bg-gray-800' : 'dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-800 text-indigo-100 hover:bg-indigo-800 hover:text-white' }} group flex w-full flex-col items-center rounded-md p-3 text-xs font-medium">
                <flux:icon.user-group
                    class="{{ request()->routeIs('alem.employees') || request()->routeIs('employees.profile') ? 'dark:text-white dark:bg-gray-800' : 'text-indigo-300 dark:text-gray-400 group-hover:text-white' }} h-6 w-6"/>
