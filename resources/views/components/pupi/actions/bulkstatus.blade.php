...
<flux:dropdown align="end" offset="-15">
    <flux:button
        class="pr-8 p-2.5 px-3 inline-flex justify-center items-center gap-2 rounded-md font-medium bg-white text-gray-700 shadow-sm align-middle hover:bg-gray-50
                        border-0 ring-1 ring-inset ring-gray-300 hover:focus:ring-2 hover:focus-within:ring-inset hover:focus-within:ring-indigo-600 focus:ring-indigo-600 dark:focus:ring-indigo-500 focus-within:ring-inset focus:ring-2 dark:hover:focus:ring-indigo-500 dark:ring-gray-700/50
