<button
    ...
    type="button"
    class="py-1.5 px-3 sm:text-sm/6 rounded-l-none inline-flex justify-center items-center gap-2 rounded-md font-medium bg-white text-gray-500 align-middle hover:bg-gray-50
