<button wire:click="resetFilters"
        ...
        class="py-1.5 px-3 sm:text-sm/6 rounded-l-none inline-flex justify-center items-center gap-2 rounded-md font-medium bg-white text-gray-500 shadow-sm align-middle hover:bg-gray-50
                         border-0 ring-1 ring-inset ring-gray-300 hover:focus:ring-2 hover:focus-within:ring-inset hover:focus-within:ring-indigo-600 dark:hover:focus:ring-indigo-500 dark:ring-gray-700/50
