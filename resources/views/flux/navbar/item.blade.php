...
$classes = Flux::classes()
    ...
    ->add(match ($variant) {
        default => [
            ...
            'data-current:after:absolute data-current:after:-bottom-3 data-current:after:inset-x-0 data-current:after:h-[2px] data-current:after:bg-zinc-800 dark:data-current:after:bg-white',
        ]
    })
    ;
@endphp
