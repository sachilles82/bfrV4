...
@php
    ...
    $classes = Flux::classes()
        ...
        ->add(match ($variant) { // Text color...
            ...
            'danger' => 'text-white',
            'ghost' => 'text-zinc-400 dark:text-gray-500',
         ...
         ->add(match ($variant) { // Border color...
            ...
            'outline' => 'border border-zinc-300 hover:border-zinc-300 border-b-zinc-300/80 dark:border-zinc-600 dark:hover:border-zinc-600',
             default => '',
        })
        ...
        ->add(match ($variant) { // Grouped border treatments...
            ...
            'filled' => 'in-data-flux-button-group:border-r [:is([data-flux-button-group]>&:last-child,_[data-flux-button-group]_:last-child>&)]:border-r-0 in-data-flux-button-group:border-zinc-300/80 dark:in-data-flux-button-group:border-zinc-900/50',
