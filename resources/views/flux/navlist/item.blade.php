...
$classes = Flux::classes()
    ...
    ->add('text-zinc-500 dark:text-white/80 hover:text-zinc-800 dark:hover:text-white')
    ->add('hover:bg-zinc-100 dark:hover:bg-white/10')
    ->add(match ($variant) {
        'outline' => 'data-current:text-zinc-800 dark:data-current:text-zinc-100 data-current:bg-white dark:data-current:bg-white/10 data-current:border data-current:border-zinc-200 dark:data-current:border-white/10 data-current:shadow-xs',
        default => 'data-current:text-zinc-800 dark:data-current:text-zinc-100 data-current:bg-zinc-800/5 dark:data-current:bg-white/10',
    })
    ;
@endphp
