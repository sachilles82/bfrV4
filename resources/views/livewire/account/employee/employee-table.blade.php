                            ...
                            <x-pupi.table.tr.cell>
                                <div class="flex items-center">
                                    ...
                                    <div x-show="checked" x-cloak class="ml-4">
                                        ...
                                        <div class="mt-1 text-gray-500 dark:text-gray-600">Team, Malermeister</div>
                                    </div>
                                    <div x-show="!checked" class="ml-4">
                                        <a wire:navigate.hover
                                           href="{{ route('employees.profile', $user->id) }}"
                                ...
                                {{--                                </div>--}}
                                {{--                                <div x-show="!checked">--}}
                                {{--                                    <a wire:navigate.hover href="{{ route('employees.profile', $user->id) }}"--}}
