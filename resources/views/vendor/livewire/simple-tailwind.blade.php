        ...
        <nav role="navigation" aria-label="Pagination Navigation" class="flex justify-between">
            <span>
                ...
                @if ($paginator->onFirstPage())
                    <span class="min-h-[38px] min-w-[38px] py-2 px-2.5 inline-flex justify-center items-center gap-x-1.5 text-sm rounded-lg text-gray-400 focus:outline-none disabled cursor-not-allowed dark:text-gray-500">
