...
enum Permission: string
{
    ...
    public function appName(): string
    {
        return match ($this) {
            ...
            Permission::DELETE_USER => 'baseApp',

            // HOLIDAY APP
            Permission::LIST_BOOKING,
            Permission::CREATE_BOOKING,
            Permission::EDIT_BOOKING,
            Permission::DELETE_BOOKING => 'holidayApp',

            // CRM APP
            Permission::LIST_CUSTOMER,
            Permission::CREATE_CUSTOMER,
            Permission::EDIT_CUSTOMER,
            Permission::DELETE_CUSTOMER => 'crmApp',

            // Project APP
            Permission::LIST_PROJECT,
            Permission::CREATE_PROJECT,
            Permission::EDIT_PROJECT,
            Permission::DELETE_PROJECT => 'projectApp',
            ...
            Permission::DELETE_OWN_STATE_CITY => 'settingApp',
        };
    }
    ...
    public function group(): string
    {
        return match ($this) {
            ...
            Permission::CREATE_COMPANY,
            Permission::EDIT_COMPANY,
            Permission::DELETE_COMPANY => 'company',
            ...
            Permission::CREATE_BOOKING,
            Permission::EDIT_BOOKING,
            Permission::DELETE_BOOKING => 'booking',

            // CRM APP
            Permission::LIST_CUSTOMER,
            Permission::CREATE_CUSTOMER,
            Permission::EDIT_CUSTOMER,
            Permission::DELETE_CUSTOMER => 'customer',

            // Project APP
            Permission::LIST_PROJECT,
            Permission::CREATE_PROJECT,
            Permission::EDIT_PROJECT,
            Permission::DELETE_PROJECT => 'project',
            ...
            Permission::DELETE_OWN_ROLE,
            Permission::UPDATE_ROLE_PERMISSIONS,
            Permission::UPDATE_OWN_ROLE_PERMISSIONS => 'role',
            ...
            Permission::EDIT_ADDRESS,
            Permission::EDIT_OWN_ADDRESS,
            Permission::DELETE_ADDRESS => 'address',
            ...
            Permission::EDIT_OWN_STATE_CITY,
            Permission::DELETE_ALL_STATE_CITY,
            Permission::DELETE_OWN_STATE_CITY => 'State City Manager',
        };
    }
