...
use Illuminate\Database\Eloquent\Builder; // Wichtig für Typhinweise
use Illuminate\Support\Facades\Auth; // Auth Facade importieren
...
class EmployeeTable extends Component
{
    ...
    public function render(): View
    {
        ...
        // Wenn kein Team gefunden wurde, leere Ergebnisse zurückgeben
        if (!$authCurrentTeamId) {
            Log::warning('Angemeldeter Benutzer hat kein aktuelles Team beim Zugriff auf EmployeeTable.', ['user_id' => Auth::id()]);
        ...
        $query->with([
            ...
            // Lade das Department direkt vom User (nur ID und Name)
            'department:id,name',
