...
use App\Livewire\Alem\Employee\Helper\Status\EmployeeModelStatus;
use App\Livewire\Alem\Employee\Helper\Status\EmployeeStatus;
...
class EmployeeTable extends Component
{
    ...
    public function render(): View
    {
        ...
        $query->select([
            ...
            'users.email', 'users.joined_at', 'users.created_at', 'users.updated_at', 'users.model_status',
